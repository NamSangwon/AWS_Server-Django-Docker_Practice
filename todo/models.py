...
class Task(models.Model):
    ...
    name = models.CharField(verbose_name="작업이름", max_length=256, null=False, default='', help_text='Todo 명')
    ...
    done = models.BooleanField(verbose_name="완료상태", null=False, default=False)
